...
// TODO Remove code when ops::Where works
...
void gather_peak_infos(const int p1, const int p2, const int p3, const float * peaks, const int const h2, const int h3, const float * heatmap, std::vector<Peak> peak_infos[NUM_PART]);
